...
namespace TennisMingle.API.Data
{
    public class TennisMingleSeeder
    {
        ...
        public void Seed()
        {
            ...
            if (_ctx.Cities.Any() && _ctx.TennisClubs.Any() && _ctx.Addresses.Any() && _ctx.Users.Any() && _ctx.Facilities.Any() && _ctx.Surfaces.Any() && _ctx.TennisCourts.Any())
            {
                return;
            }
